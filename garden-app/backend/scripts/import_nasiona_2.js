...
/**
 * Skrypt importu odmian roślin z katalogów polskich firm nasiennych
 * W. Legutko, Plantico, Torseed, Plantini
 */
...
const FILES = [
  'legutko_warzywa.json',
  'legutko_kwiaty.json',
  'plantico_warzywa_kwiaty.json',
  'torseed_warzywa_kwiaty.json',
  'plantini_pro_f1.json'
];

console.log('🌱 Garden App - Import odmian (Legutko, Plantico, Torseed, Plantini)');
console.log('=================================================================\n');
