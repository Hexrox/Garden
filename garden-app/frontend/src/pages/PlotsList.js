  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link
          to="/plots/new"
          className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800"
        >
          + Dodaj poletko
        </Link>
      </div>
            ...
            <div key={plot.id} className="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-2">
                  <Link
                    to={`/plots/${plot.id}`}
                    className="flex-1 text-center px-4 py-2 border border-green-600 dark:border-green-500 rounded-md text-sm font-medium text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/20"
                  >
                    Szczegóły
                  </Link>
                  <Link
                  ...
                  <button
                    ...
                    className="px-4 py-2 border border-red-300 dark:border-red-800 rounded-md text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20"
                  >
                    Usuń
                  </button>
                </div>
