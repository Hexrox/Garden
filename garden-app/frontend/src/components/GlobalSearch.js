  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto animate-fade-in">
      ...
      <div className="relative min-h-screen flex items-start justify-center p-4 pt-[10vh]">
        <div className="relative w-full max-w-2xl bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-xl shadow-2xl overflow-hidden border border-white/20 dark:border-gray-700/50 animate-fade-in-up">
          {/* Search Input */}
