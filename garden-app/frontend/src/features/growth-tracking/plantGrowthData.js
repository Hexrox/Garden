...
export const plantGrowthData = {
  ...
  słonecznik: {
    ...
    flower_color: 'Żółty',
    bloom_season: 'Lato-Jesień',
    height: '150-200cm',
    sun_requirement: 'Pełne słońce',
  },
  aksamitka: {
    daysToHarvest: 50,
    category: 'Kwiaty jednoroczne',
    notes: 'Szybko kwitnie, odpędza szkodniki',
    flower_color: 'Żółty, Pomarańczowy, Czerwony',
    bloom_season: 'Lato-Jesień',
    height: '20-40cm',
    sun_requirement: 'Pełne słońce',
  },
  ...
  petunie: {
    ...
    bloom_season: 'Lato-Jesień',
    height: '20-40cm',
    sun_requirement: 'Pełne słońce do półcienia',
  },
  bratek: {
    daysToHarvest: 65,
    category: 'Kwiaty jednoroczne',
  ...
  kosmos: {
    ...
    flower_color: 'Różowy, Biały, Fioletowy',
    bloom_season: 'Lato-Jesień',
    height: '60-120cm',
    sun_requirement: 'Pełne słońce',
  },
  ...
  piwonia: {
    ...
    flower_color: 'Różowy, Biały, Czerwony',
    bloom_season: 'Wiosna-Wczesne lato',
    height: '60-90cm',
    sun_requirement: 'Pełne słońce do półcienia',
    is_perennial: true,
  },
  ...
  hosta: {
    ...
    flower_color: 'Biały, Fioletowy',
    bloom_season: 'Lato',
    height: '30-60cm',
    sun_requirement: 'Cień do półcienia',
    is_perennial: true,
  },
  rudbeckia: {
    daysToHarvest: 100,
  ...
  echinacea: {
    ...
    flower_color: 'Różowy, Fioletowy, Biały',
    bloom_season: 'Lato',
    height: '60-120cm',
    sun_requirement: 'Pełne słońce',
    is_perennial: true,
  ...
  dzwonek: {
    ...
    flower_color: 'Niebieski, Biały, Fioletowy',
    bloom_season: 'Lato',
    height: '30-100cm',
    sun_requirement: 'Pełne słońce do półcienia',
    is_perennial: true,
  ...
  tulipan: {
    ...
    height: '30-60cm',
    sun_requirement: 'Pełne słońce',
    planting_time: 'Jesień',
  },
  narcyz: {
    daysToHarvest: 180,
    category: 'Kwiaty cebulowe',
    notes: 'Sadzenie jesienią, bardzo trwałe',
    flower_color: 'Żółty, Biały',
    bloom_season: 'Wiosna',
    height: '30-50cm',
    sun_requirement: 'Pełne słońce do półcienia',
    planting_time: 'Jesień',
  ...
  krokus: {
    ...
    flower_color: 'Fioletowy, Żółty, Biały',
    bloom_season: 'Wczesna wiosna',
    height: '10-15cm',
    sun_requirement: 'Pełne słońce',
    planting_time: 'Jesień',
  },
